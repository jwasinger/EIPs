...
def state_transition(block):
    ...
    for idx, tx in enumerate(block.transactions):
        ...
        nonce_diffs = get_nonce_diffs(tx)
        for address, addr_nonce_diffs in nonce_diffs:
            computed_nonce_diffs[address] = []
            for (tx_idx, pre_nonce) in addr_nonce_diffs:
                computed_nonce_diffs[address].append((tx_idx, pre_nonce))
